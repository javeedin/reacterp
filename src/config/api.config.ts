...
export const ORACLE_FUSION_CONFIG = {
  ...
  username: (import.meta.env.REACT_APP_FUSION_SVC_USER as string) || '',
  password: (import.meta.env.REACT_APP_FUSION_SVC_PASSWORD as string) || '',
  defaultLimit: 500,
...
export const ORACLE_SOAP_CONFIG = {
  ...
  test: {
    ...
    username: (import.meta.env.REACT_APP_FUSION_TEST_USER as string) || '',
    password: (import.meta.env.REACT_APP_FUSION_TEST_PASSWORD as string) || '',
  },
  reports: {
