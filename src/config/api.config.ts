...
export const SYNC_OBJECTS: SyncObjectConfig[] = [
  ...
  },
  {
    ...
    description: 'Sync AR Payment Terms from Fusion paymentTermsLOV',
    oracleEndpoint: 'paymentTermsLOV',
    apexEndpoint: 'ar/payment-terms/bulk',
    parameters: [],
  },
  {
    id: 'ar-txn-sources',
    name: 'AR Transaction Sources',
    description: 'Sync AR Transaction Sources from Fusion transactionSourcesLOV',
    oracleEndpoint: 'transactionSourcesLOV',
    apexEndpoint: 'ar/txn-sources/bulk',
    parameters: [],
  },
  {
    id: 'ar-txn-types',
    name: 'AR Transaction Types',
    description: 'Sync AR Transaction Types from Fusion transactionTypesLOV',
    oracleEndpoint: 'transactionTypesLOV',
    apexEndpoint: 'ar/txn-types/bulk',
    parameters: [],
  },
  {
    id: 'ar-memo-lines',
    name: 'AR Memo Lines',
    description: 'Sync AR Memo Lines from Fusion memoLinesLOV',
    oracleEndpoint: 'memoLinesLOV',
    apexEndpoint: 'ar/memo-lines/bulk',
    parameters: [],
  },
  {
    id: 'ar-revenue-sched-rules',
    name: 'AR Revenue Scheduling Rules',
    description: 'Sync AR Revenue Scheduling Rules from Fusion revenueSchedulingRulesLOV',
    oracleEndpoint: 'revenueSchedulingRulesLOV',
    apexEndpoint: 'ar/revenue-sched-rules/bulk',
    parameters: [],
  },
  {
    id: 'ar-credit-memos',
