...
const CreateAccounting: React.FC = () => {
  ...
  const [bankAccounts, setBankAccounts]         = useState<{ bankAccountName: string; cashClearingAccountCombination: string }[]>([]);
    ...
    for (const row of rows) {
      ...
      try {
        if (target === 'invoices') {
          ...
          const cashClearing = bank?.cashClearingAccountCombination || '02-00-00-1011001-0000-000-00-000-000';
          ...
          const payloads = buildApPaymentSlaPayloads({
            ...
            ledgerId:        ledgerInfo?.ledgerId,
            ledgerName:      ledgerInfo?.ledgerName,
            cashClearingAccount: cashClearing,
