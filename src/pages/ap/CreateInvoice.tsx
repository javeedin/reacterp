        ...
        {(() => {
          ...
          const apis = [
            ...
            ...(pendingInst.length > 0 ? [{
              ...
              method: 'POST',
              color: '#52c41a',
              url: `${APEX_DB_CONFIG.baseUrl}/ap/invoices/installments`,
              desc: `✅ Endpoint EXISTS — POST to /ap/invoices/installments with items array. Sets UnpaidAmount=0 for each pending installment (${pendingInst.length} installment${pendingInst.length > 1 ? 's' : ''}) to mark them as fully paid.`,
              body: {
                items: pendingInst.map(i => ({
                  InvoiceId:               invoiceId,
                  InstallmentNumber:       i.installmentNumber,
                  DueDate:                 i.dueDate || null,
                  GrossAmount:             i.grossAmount,
                  UnpaidAmount:            0,
                  PaymentPriority:         i.paymentPriority || null,
                  PaymentMethod:           i.paymentMethod || null,
                  PaymentMethodCode:       null,
                  BankAccount:             i.bankAccount || fv.disbursementBankAccount || null,
                  HoldFlag:                'false',
                  HoldReason:              null,
                  HoldType:                null,
                  HoldDate:                null,
