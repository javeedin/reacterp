-- ============================================================
-- Fix RR_INSERT_GL_JOURNALS_POST:
-- Always calculate ACCOUNTED_DR / ACCOUNTED_CR as
--   entered_amount × effective_conversion_rate
-- instead of trusting whatever the frontend sends.
--
-- Effective rate priority:
--   1. line-level currencyConversionRate
--   2. header-level currencyConversionRate
