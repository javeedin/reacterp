...
BEGIN
    ...
    FOR rec IN (
        SELECT
            ...
            jls.CURRENCY_CODE,
            NVL(l.CURRENCY_CONVERSION_RATE,        h.CURRENCY_CONVERSION_RATE)        AS CURRENCY_CONVERSION_RATE,
            NVL(l.USER_CURRENCY_CONVERSION_TYPE,   h.USER_CURRENCY_CONVERSION_TYPE)   AS USER_CURRENCY_CONVERSION_TYPE,
            NVL(l.CURRENCY_CONVERSION_DATE,        h.CURRENCY_CONVERSION_DATE)        AS CURRENCY_CONVERSION_DATE,
        ...
        APEX_JSON.WRITE('conversionRate',     NVL(rec.CURRENCY_CONVERSION_RATE, 1));
        APEX_JSON.WRITE('conversionRateType', rec.USER_CURRENCY_CONVERSION_TYPE);
        APEX_JSON.WRITE('conversionDate',     TO_CHAR(rec.CURRENCY_CONVERSION_DATE, 'YYYY-MM-DD'));
