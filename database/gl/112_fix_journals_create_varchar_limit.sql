-- ============================================================
-- 112_fix_journals_create_varchar_limit.sql
-- Fix ORA-40478 in RR_INSERT_GL_JOURNALS_POST.
--
-- ONLY CHANGE vs current procedure:
--   safe_get_string now uses get_clob() instead of get_string().
--   JSON_OBJECT_T.get_string() throws ORA-40478 when the value
--   exceeds 4000 chars. get_clob() has no such limit; SUBSTR then
--   caps it to VARCHAR2 size before assignment.
-- Everything else is identical to the live procedure.
-- ============================================================
