-- ============================================================
-- PATCH 88: Revert RR_INSERT_GL_JOURNALS_POST to patch-86 version
--
-- Patch 87 added Rev:/Copy: prefix detection which is no longer
-- needed — the frontend now opens a draft tab and only calls
-- POST /journals/create when the user clicks Save.  The procedure
-- must always assign "Manual - <batch_id>" for all new journals.
--
-- Run this single block in APEX SQL Workshop → SQL Commands.
-- ============================================================
...
BEGIN
    DBMS_OUTPUT.PUT_LINE('PATCH 88 applied: RR_INSERT_GL_JOURNALS_POST reverted to patch-86 (Manual - <id> naming, no Rev/Copy prefix logic)');
END;
/
