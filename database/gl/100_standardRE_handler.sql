-- ============================================================
-- 100: ORDS handler for gl/rr-trialbalance/standardRE
--
-- Returns saved Retained Earnings rows only.
-- UI merges with gl/rr-trialbalance/standard response.
--
...
BEGIN
    ...
    ORDS.DEFINE_TEMPLATE(
        ...
        p_etag_type   => 'HASH',
        p_etag_query  => NULL,
        p_comments    => 'Retained Earnings rows for YTD Trial Balance'
    );
