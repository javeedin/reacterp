...
--
-- Uses plsql/block + REF CURSOR (most reliable for complex queries).
...
-- ─────────────────────────────────────────────────────
-- GET gl/lines-summary  (plsql/block + REF CURSOR)
--
-- Params:
...
-- ─────────────────────────────────────────────────────
-- GET gl/lines-summary/diag  (plsql/block + REF CURSOR)
-- ─────────────────────────────────────────────────────
BEGIN
    ORDS.DEFINE_HANDLER(
        p_module_name    => 'reerp',
