...
-- Table: RR_AR_INVOICE_INSTALLMENTS
-- =====================================================
...
CREATE TABLE RR_AR_INVOICE_INSTALLMENTS (
    ...
    CONSTRAINT RR_AR_INV_INST_UK UNIQUE (INVOICE_ID, INSTALLMENT_NUMBER)
);

-- Create indexes for performance
CREATE INDEX RR_AR_INV_INST_INV_ID_IDX ON RR_AR_INVOICE_INSTALLMENTS(INVOICE_ID);
CREATE INDEX RR_AR_INV_INST_DUE_DATE_IDX ON RR_AR_INVOICE_INSTALLMENTS(DUE_DATE);
CREATE INDEX RR_AR_INV_INST_STATUS_IDX ON RR_AR_INVOICE_INSTALLMENTS(PROCESS_STATUS);
CREATE INDEX RR_AR_INV_INST_HOLD_IDX ON RR_AR_INVOICE_INSTALLMENTS(HOLD_FLAG);

-- Add comments
COMMENT ON TABLE RR_AR_INVOICE_INSTALLMENTS IS 'Staging table for AP Invoice Installments from Oracle Fusion';
COMMENT ON COLUMN RR_AR_INVOICE_INSTALLMENTS.INVOICE_ID IS 'Foreign key to XXAP_INVOICES_STG.INVOICE_ID';
COMMENT ON COLUMN RR_AR_INVOICE_INSTALLMENTS.INSTALLMENT_NUMBER IS 'Installment number within the invoice';
COMMENT ON COLUMN RR_AR_INVOICE_INSTALLMENTS.PROCESS_STATUS IS 'NEW, PROCESSED, ERROR';
COMMENT ON COLUMN RR_AR_INVOICE_INSTALLMENTS.HOLD_FLAG IS 'Y if installment is on hold, N otherwise';

-- Grant permissions (adjust schema as needed)
-- GRANT SELECT, INSERT, UPDATE, DELETE ON RR_AR_INVOICE_INSTALLMENTS TO your_app_user;
