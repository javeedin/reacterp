-- =====================================================
-- AR Adjustments PL/SQL Package
-- Package : RR_AR_ADJUSTMENTS_PKG
-- Table   : RR_AR_ADJUSTMENTS
-- =====================================================

CREATE OR REPLACE PACKAGE RR_AR_ADJUSTMENTS_PKG AS
...
CREATE OR REPLACE PACKAGE BODY RR_AR_ADJUSTMENTS_PKG AS
    ...
    -- Processes each Fusion receivablesAdjustments record.
    -- Uses row-by-row MERGE so individual errors are captured.
    -- -------------------------------------------------------
    PROCEDURE save_adjustments_bulk (
        p_json      IN  CLOB,
        p_status    OUT VARCHAR2,
        ...
        FOR rec IN (
            ...
            BEGIN
                ...
                WHEN NOT MATCHED THEN INSERT (
                    ...
                    ACCOUNT_COMBINATION,      FUSION_CREATED_BY,
                    ...
                    rec.ACCOUNT_COMBINATION,  rec.FUSION_CREATED_BY,
