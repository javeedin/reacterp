...
CREATE OR REPLACE PACKAGE BODY RR_FA_PKG AS
    ...
    BEGIN
        ...
        FOR r IN (
            SELECT a.ASSET_ID,
                   ...
                   a.LAST_UPDATED_BY,
                   b.BOOK_TYPE_CODE,
                   TO_CHAR(b.DATE_PLACED_IN_SERVICE, 'YYYY-MON-DD') AS DATE_PLACED_IN_SERVICE,
                   b.COST,
                   b.ORIGINAL_COST,
                   b.ADJUSTED_COST,
                   b.SALVAGE_VALUE,
    ...
    BEGIN
        SELECT tl.ASSET_ID, tl.DESCRIPTION, tl.LANGUAGE, tl.SOURCE_LANG,
               ...
               b.BOOK_TYPE_CODE, TO_CHAR(b.DATE_PLACED_IN_SERVICE, 'YYYY-MON-DD') AS DATE_PLACED_IN_SERVICE, b.DATE_EFFECTIVE,
