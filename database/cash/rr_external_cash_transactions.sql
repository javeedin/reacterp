...
BEGIN
    ...
    LOOP
        ...
        DBMS_LOB.APPEND(v_clob, TO_CLOB(
         ...
         || '"amount":'                    || NVL(TO_CHAR(r.AMOUNT, 'FM99999999999999990.9999999999'), 'null') || ','
         ...
         || '"bankConversionRate":'        || NVL(TO_CHAR(r.BANK_CONVERSION_RATE,'FM99999999999999990.9999999999'),'null') || ','
